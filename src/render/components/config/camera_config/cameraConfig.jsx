...
function cameraConfig(){
    return(
        <div className="px-7 py-5">
            ...
            <div>
                <p className="font-roboto font-bold text-white text-[18pt]">Camera Configuration</p>
                ...
                <div className="mt-5">
                    ...
                    <div className="mt-3">
                            <select className="bg-palette-gray100 text-white text-[10pt] pl-3 font-roboto h-10 w-64 rounded-md cursor-pointer drop-shadow-lg" name="channels" id="channels">
