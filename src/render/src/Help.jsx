      ...
      <div className="flex justify-center pt-10">
        <div className="md:w-3/4 lg:w-[800px] pb-1/4">
            ...
            <div label='Live Module'>
                ...
                <br/>
                <img src="./screens/live.png" className="w-9/12 rounded-lg"/>
                <br/>
            ...
            <br/>
                <ol className="list-decimal list-inside">
                    ...
                    <li>In the sources panel add a media source.
                        <img src="./screens/obs1.png" className="w-9/12 rounded-lg"/>
                        <br/>
                    </li>
                    <li>Uncheck the local file checkbox and add the streaming URL of your CCTV / IP camera in the input field.
                        <img src="./screens/obs2.png" className="w-9/12 rounded-lg"/>
                        <br/>
                    </li>
                    <li>Select OBS Virtual Camera as Camera input device in the app.
                        <img src="./screens/camconfig.png" className="w-9/12 rounded-lg"/>
                        <br/>
                    </li>
                    <li>Start a live detection.
                        <img src="./screens/livenet.png" className="w-9/12 rounded-lg"/>
                    </li>
                </ol>
            <br/>
            <p className="text-[8pt]">
            ...
            <div label='File Module'>
                ...
                <br/>
                <img src="./screens/file.png" className="w-9/12 rounded-lg"/>
            </div>
            <div label='Logging Threshold'>
                ...
                <br/>
                <img src="./screens/threshold.png" className="w-9/12 rounded-lg"/>
            </div>
