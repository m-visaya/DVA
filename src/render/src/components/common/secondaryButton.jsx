    ...
    return(
      ...
      >
        <div className="flex justify-center h-full items-center">
          <div className="grid grid-cols-4 gap-x-2 flex h-full items-center">
            <div className="col-span-1">
              <img src={iconImage} className="lg:w-4 md:w-3"></img>
            </div>
            <div className="col-span-3 flex justify-center">
              <p className="text-palette-gray100 dark:text-palette-gray50 font-roboto lg:text-[10pt] md:text-[8pt] ">
                {iconTitle}
              </p>
            </div>
          </div>
